...
function makeSandbox() {
  ...
  class Node { connect() { return this; } disconnect() {} toDestination() { return this; } dispose() {} }
  class Synth extends Node { constructor() { super(); this.frequency = param(); this.detune = param(); } triggerAttack() {} triggerRelease() {} }
